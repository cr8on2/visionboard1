...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { caption: @music.caption, genre: @music.genre, mp3: @music.mp3, slideshow_id: @music.slideshow_id, user_id: @music.user_id }
    end
  ...
  test "should update music" do
    put :update, id: @music, music: { caption: @music.caption, genre: @music.genre, mp3: @music.mp3, slideshow_id: @music.slideshow_id, user_id: @music.user_id }
    assert_redirected_to music_path(assigns(:music))
  end
