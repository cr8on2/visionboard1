...
class SlideshowsControllerTest < ActionController::TestCase
  ...
  test "should create slideshow" do
    assert_difference('Slideshow.count') do
      post :create, slideshow: { objective: @slideshow.objective, title: @slideshow.title, user_id: @slideshow.user_id }
    end
  ...
  test "should update slideshow" do
    put :update, id: @slideshow, slideshow: { objective: @slideshow.objective, title: @slideshow.title, user_id: @slideshow.user_id }
    assert_redirected_to slideshow_path(assigns(:slideshow))
  end
